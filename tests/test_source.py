...
class TestPointSource():
	...
	def test_getProgenyPhotonEnergyList(self):
		...
		print(a)
		np.testing.assert_allclose(a, \
			[(1.5737E-02, 4.1498E-05 * 3.7e10 * 3.14), \
			 (1.7617E-02, 3.2727E-06 * 3.7e10 * 3.14), \
			 (1.7631E-02, 6.3727E-06 * 3.7e10 * 3.14), \
			 (1.7769E-02, 1.3642E-08 * 3.7e10 * 3.14), \
			 (1.7771E-02, 1.9378E-08 * 3.7e10 * 3.14), \
			 (1.7923E-02, 5.3591E-07 * 3.7e10 * 3.14), \
			 (1.7925E-02, 1.0292E-06 * 3.7e10 * 3.14), \
			 (1.7955E-02, 1.9268E-10 * 3.7e10 * 3.14), \
			 (1.7956E-02, 2.7187E-10 * 3.7e10 * 3.14), \
			 (0.037052, (3.91850e-01)*1e6), \
			 (0.04885, (3.31130e-03)*1e6), \
			 (0.9876, 3.14E2), \
			 (2.1862E+00, 1.4000E-08 * 3.7e10 * 3.14)])
...
class TestLineSource():
	...
	def test_getPhotonEnergyList(self):
		...
		np.testing.assert_allclose(a, \
			[(0.037052, (3.91850e-01)*1e6/10), \
			 (0.04885, (3.31130e-03)*1e6/10), \
			 (0.9876, 3.14E2/10), \
			 (1.2936, 9.91600e-01 * 3.7e10 * 3.14 / 10), \
			 (1.677, 5.15630e-04 * 3.7e10 * 3.14 / 10)])
...
class TestBoxSource():
	...
	def test_getSourcePoints(self):
		...
		a = my_source._get_photon_source_list()
		np.testing.assert_allclose(a, \
			[(0.037052, (3.91850e-01)*1e6/8), \
			 (0.04885, (3.31130e-03)*1e6/8), \
			 (0.9876, 3.14E2/8), \
			 (1.2936, 9.91600e-01 * 3.7e10 * 3.14 / 8), \
			 (1.677, 5.15630e-04 * 3.7e10 * 3.14 / 8)])
...
class TestZAlignedCylinderSource():
	...
	def test_getSourcePoints(self):
		...
		np.testing.assert_allclose(a, \
			[(0.037052, (3.91850e-01)*1e6/27), \
			 (0.04885, (3.31130e-03)*1e6/27), \
			 (0.9876, 3.14E2/27), \
			 (1.2936, 9.91600e-01 * 3.7e10 * 3.14 / 27), \
			 (1.677, 5.15630e-04 * 3.7e10 * 3.14 / 27)])
